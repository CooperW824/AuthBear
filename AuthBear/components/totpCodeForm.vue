...
<template>
    ...
    <div v-if="!scan_on" class="display-flex">
        <div>
            <button class="btn btn-primary" type="button" @click="startQRScan">
        ...
        <div>
            ...
            <input id="account_name_input" type="text" v-model="account_name" class="form-control" placeholder="Account Name">
